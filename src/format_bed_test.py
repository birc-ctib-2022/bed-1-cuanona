...
def test_it_works_with_general_bed_line():
    """Given bed line with different whitespaces, `parse_bed` works correctly."""
...
def test_it_raises_exception_when_more_columns():
    """Given bed line with more than 4 columns, `parse_bed` raises ValueError."""
...
def test_it_raises_exception_when_less_columns():
    """Given bed line with less than 4 columns, `parse_bed` raises ValueError."""
...
def test_it_prints_strict_bed_line(capsys):
    """Given BedLine tuple, `print_line` uses \t."""
